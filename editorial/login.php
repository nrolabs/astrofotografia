<?php 
	...
	if (isset($_POST['epassword']) && isset($_POST['eemail']) ) {
		$editorial = $api->doLogin($_POST['eemail'], $_POST['epassword']);
		if (isset($editorial['eid'])) {
			$_SESSION['eid'] = $editorial['eid'];
			$_SESSION['enome'] = $editorial['enome'];
			$_SESSION['eemail'] = $editorial['eemail'];
		}
	}
